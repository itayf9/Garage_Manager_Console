...
namespace Ex03.GarageLogic
{
    public class Motorcycle : Vehicle
    {
        ...
        public Motorcycle(string i_ModelName, string i_LisenceNumber, Energy i_EnergySource, List<Wheel> i_Wheels, eLisenceType i_LisenceType, int i_EngineVolume) : base(i_ModelName, i_LisenceNumber, i_EnergySource, i_Wheels)
        {
